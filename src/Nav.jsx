...
<>
    <div className='navbar  h-12 flex rounded-3xl overflow-hidden justify-between px-4 backdrop-blur-3xl z-10'>
      ...
      >
<a href="https://linktr.ee/harshitsoni10" target="_blank">Linktree</a>

      </div>
      <div className="rightbox right w-2/6">
        <ul className='flex h-full justify-between'>
          <li className='h-full flex justify-center items-center navlistitem'><a href="https://linktr.ee/harshitsoni10" target="_blank">Linktree</a></li>
